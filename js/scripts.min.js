Cookies={createComponent:function(){(container=document.createElement("div")).classList.add("cookies");var e=document.createElement("div"),o=(e.classList.add("cookie-box"),container.appendChild(e),document.createElement("p")),t=document.createTextNode("Utilizamos cookies em nosso site para lhe oferecer melhor experiência na navegação, melhorar o desempenho e analisar como você interage para personalizar conteúdo exclusivamente para você."),t=(o.appendChild(t),e.appendChild(o),document.createElement("div")),o=(t.classList.add("buttons-choice"),e.appendChild(t),document.createElement("button")),e=(o.classList.add("button-cookie-choice"),o.setAttribute("data-choice","N"),document.createTextNode("Recusar")),e=(o.appendChild(e),t.appendChild(o),document.createElement("button")),o=(e.classList.add("button-cookie-choice"),e.setAttribute("data-choice","S"),document.createTextNode("Aceitar"));return e.appendChild(o),t.appendChild(e),document.body.appendChild(container),container},removeComponent:function(){document.body.removeChild(container)},insertScripts:function(){},init:function(){if(localStorage.getItem("choiceCookieUser"))"Allowed"==localStorage.getItem("choiceCookieUser")&&Cookies.insertScripts();else{containerCookie="",Cookies.createComponent();var e=document.querySelectorAll(".button-cookie-choice");for(i=0;i<e.length;i++)e[i].addEventListener("click",function(){switch(this.dataset.choice){case"N":localStorage.setItem("choiceCookieUser","Denied");break;case"S":localStorage.setItem("choiceCookieUser","Allowed"),Cookies.insertScripts()}Cookies.removeComponent()})}}};
window.addEventListener("load",function(){let e=document.querySelector("#menu");e.addEventListener("click",function(){this.classList.toggle("menu-open"),console.log(this)}),(new WOW).init(),Cookies.init()});
